...
const Products = () => {
  ...
  const imageUrl = "https://realauto.limsa.uz/api/brands";
          ...
          >
            {brands.map(category => (
              <motion.div   
                ...
                className="grid grid-cols-1 gap-5 p-4 bg-gray-400 rounded-2xl shadow-lg hover:shadow-2xl hover:scale-105 transition-transform duration-300 cursor-pointer"
              >
                ...
                <motion.img
                  ...
                  className="w-[350px] h-[230px] object-cover rounded-lg"  // Уменьшено до 350x230
